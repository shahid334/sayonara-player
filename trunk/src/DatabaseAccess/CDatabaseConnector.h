...
class CDatabaseConnector : public QObject
{
	...
	/*
			 * Playlist
			 * */
	bool getAllPlaylistSkeletons(QList<CustomPlaylistSkeleton>& skeletons, CDatabaseConnector::PlaylistChooserType type, SortOrderPlaylists sortorder=NameAsc);
